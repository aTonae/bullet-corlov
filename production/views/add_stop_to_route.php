          ...
          <div class="">
            ...
            <!-- create form -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="post" action="/admin/production/views/addstoptoroute" class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Stop Detail <span class="required">*</span>
                        </label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <select class="form-control" name="stop_id">
                            <option>Select Stop</option>
                            <?php foreach ($data['stop']as $key => $value) { ?>
                                   <option value="<?= $value['id'] ?>"><?= $value['stop_code']." / ".$value['name']?></option>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      foreach ($data['set'] as $key => $value) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $value['r_name']==null?"No Data":$value['r_name']; ?></td>
                          <td><?php echo $value['s_code']==null?"No Data":$value['s_code']; ?></td> 
                          <td><?php echo $value['s_name']==null?"No Data":$value['s_name']; ?></td>                          
